<template>
    ...
    <div class="bg-white rounded-2xl shadow-md px-10 py-12 w-full max-w-md text-center">
      ...
      <form @submit.prevent="handleLogin">
        ...
        <button
          type="submit"
          class="bg-[#131416] text-white px-6 py-2 rounded-lg hover:opacity-90 transition"
        >
          Login
        </button>
      </form>
  ...
  methods: {
    handleLogin() {
      ...
      if (this.email === validEmail && this.password === validPassword) {
        ...
        this.$router.push("/"); // Pastikan route "/home" sudah tersedia
      } else {
